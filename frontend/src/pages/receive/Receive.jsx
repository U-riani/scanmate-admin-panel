...
import CreateReceiveModal from "../../components/receive/CreateReceiveModal";
...
export default function Receive() {
  const { data: docs = [], isLoading } = useReceives();
  ...
  return (
    <div className="space-y-5">
      <CreateReceiveModal open={createOpen} onClose={() => setCreateOpen(false)} />
              ...
              filtered.map((doc) => (
                <tr key={doc.id}>
                  ...
                  <td className="cell-muted" style={{ fontSize: "0.8125rem" }}>
                    {getEmployeeNames(doc.receiver_user_ids)}
                  </td>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => navigate(PATHS.RECEIVE_DETAIL(doc.id))}
                    >
                      Open →
                    </button>
                  </td>
